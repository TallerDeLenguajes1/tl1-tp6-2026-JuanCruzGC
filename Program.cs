...
//-----------PUNTO 4-----------
        ...
        Console.WriteLine($"Concatenacion:{cadena1+cadena2}");
        //-----4)c)-----
        Console.WriteLine($"SubCadena:{(cadena1+cadena2).Substring(2)}");
        //-----4)d)-----
        // int num1=0;
        // int num2=0;
        // string ingreso1,ingreso2,seguirOperando,operacion;
        ...
        //     {
        //         case "1":    
        //             Console.WriteLine($"La suma de {num1.ToString()} y {num2.ToString()} es: {(num1+num2).ToString()}");
        //         break;
        //         case "2":
        //             Console.WriteLine($"La resta de {num1.ToString()} y {num2.ToString()} es: {(num1-num2).ToString()}");
        //         break;
        //         case "3":
        //             Console.WriteLine($"El producto de {num1.ToString()} y {num2.ToString()} es: {(num1*num2).ToString()}");
        //         break;
        //         case "4":
        //             Console.WriteLine($"La division de {num1.ToString()} y {num2.ToString()} es: {(num1/num2).ToString()}");
        //         break;
        //     }
        //     Console.WriteLine("Desea seguir operando?  1:Si");
        //     seguirOperando=Console.ReadLine();
        ...
        //-----4)f)-----
        string ocur;
        Console.WriteLine("Ingrese una palabra para contar las ocurrencias de la misma en la cadena");
        ocur=Console.ReadLine();
        Console.WriteLine($"Cantidad de ocurrencias: {Regex.Matches((cadena1+cadena2),ocur).Count}");
        //-----4)g)-----
        Console.WriteLine($"Mayusculas:{(cadena1+cadena2).ToUpper()}");
        Console.WriteLine($"Minusculas:{(cadena1+cadena2).ToLower()}");
        //-----4)h)-----
        string[] arreglo;
        arreglo=(cadena1+cadena2).Split(',');
        foreach(string elemento in arreglo)
        {
                Console.WriteLine(elemento);
        }
        //-----4)i)-----
        Console.WriteLine("Ingrese una ecuacion simple (solo sumas)");
        string ecuacion;
        string[] terminos;
        ...
        foreach(string elemento in terminos)
        {
                if(int.TryParse(elemento, out numero))  resultado=resultado+numero;
                else
                {
                        sonNumeros=false;
                        break;
        ...
        if(!sonNumeros) Console.WriteLine("La ecuacion ingresada no es valida");
        else    Console.WriteLine($"El resultado de la ecuacion es {resultado}");